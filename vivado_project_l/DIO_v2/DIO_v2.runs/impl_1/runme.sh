...
HD_PWD='Y:/Programs/vivado_project/DIO_v2/DIO_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DIO.tcl -notrace
