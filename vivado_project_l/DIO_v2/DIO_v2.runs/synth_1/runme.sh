...
HD_PWD='Y:/Programs/vivado_project/DIO_v2/DIO_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DIO.tcl
