...
HD_PWD='Z:/Users/apple/vivado_project/Fibonacii_output/Fibonacii_output.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fibonacii.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fibonacii.tcl -notrace
