...
HD_PWD='Y:/Programs/vivado_project/dis_v2/dis_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log getall_v2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source getall_v2.tcl -notrace
