...
HD_PWD='Y:/Programs/vivado_project/dis_v2/dis_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log getall_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source getall_v2.tcl
