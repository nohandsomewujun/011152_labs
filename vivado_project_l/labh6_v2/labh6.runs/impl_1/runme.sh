...
HD_PWD='Y:/Programs/vivado_project/labh6_v2/labh6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Print.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Print.tcl -notrace
