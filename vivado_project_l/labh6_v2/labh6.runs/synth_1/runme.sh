...
HD_PWD='Y:/Programs/vivado_project/labh6_v2/labh6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Print.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Print.tcl
