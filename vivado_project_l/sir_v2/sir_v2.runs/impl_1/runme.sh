...
HD_PWD='Y:/Programs/vivado_project/sir_v2/sir_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sir.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sir.tcl -notrace
