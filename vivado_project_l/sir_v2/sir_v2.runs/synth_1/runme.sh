...
HD_PWD='Y:/Programs/vivado_project/sir_v2/sir_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sir.tcl
